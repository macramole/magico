...
class My_Loader extends CI_Loader
{
	 ...
	 * Model Loader
	 *
	 * The same function from the core but with a $instantiate parameter default to false. 
	 * 
	 * Since mâgico has a bunch of static methods it is usually not needed to instantiate a model object
	 * 
	 */
	public function model($model, $instantiate = false, $name = '', $db_conn = FALSE)
	{
		if (is_array($model))
		{
