...
class phpmailer {
 ...
 /**
  ...
  public function IsHTML($ishtml = true) {
    if ($ishtml) {
      $this->MY_Model = 'text/html';
    } else {
      $this->MY_Model = 'text/plain';
    }
  }
  ...
  public function PreSend() {
    try {
      ...
      if(!empty($this->AltBody)) {
        $this->MY_Model = 'multipart/alternative';
      }
  ...
  */
  ...
  public function GetMailMIME() {
    ...
    switch($this->message_type) {
      ...
      default:
        ...
        $result .= $this->TextLine('Content-Type: '.$this->MY_Model.'; charset='.$this->CharSet);
        break;
    }
   ...
   * @param string $MY_Model
   * @param string $encoding
   * @return string
   */
  protected function GetBoundary($boundary, $charSet, $MY_Model, $encoding) {
    $result = '';
    if($charSet == '') {
    ...
    $result .= sprintf("Content-Type: %s; charset=%s", $MY_Model, $charSet);
    $result .= $this->LE;
